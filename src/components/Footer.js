            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="md:flex md:items-center md:justify-between md:flex-row  md:py-8 flex justify-center flex-col py-4 border-t border-gray-200">
                    ...
                    <ul className="flex justify-between mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li className="ml-4">
                            <a href="https://github.com/VinciGit00/Scrapegraph-ai?tab=readme-ov-file" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-light hover:bg-light-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                        ...
                        <li className="ml-4">
                            <a href="https://twitter.com/scrapegraphai" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-light hover:bg-light-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
                                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="ml-4">
                            <a href="https://www.linkedin.com/company/scrapegraphai/" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-light hover:bg-light-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="LinkdedIn">
                        ...
                        <li className="ml-4">
                            <a href="https://discord.com/invite/gkxQDAjfeX" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-light hover:bg-light-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Discord">
                                <svg className="w-8 h-8  fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="-4 -4 32 32">
                        ...
                        <li className="ml-4">
                            <a href="https://www.youtube.com/@ScrapeGraphAI" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-light hover:bg-light-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="YouTube">
