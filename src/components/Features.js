...
import Logo from '../assets/scrapegraphai_logo.png'
...
const Features = () => {
    ...
    return (
      ...
      <div className="bg-darker-800 absolute inset-0 pointer-events-none mb-16" aria-hidden="true"></div>
            ...
            <div className="relative pb-16 max-w-6xl mx-auto px-4 sm:px-6">
                <div className="pt-12 md:pt-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        ...
                        <p className="text-xl text-gray-300">You do not need anymore to know HTML code for scraping</p>
                    </div>
                    ...
                    <div className="md:grid md:grid-cols-12 md:gap-6">
                        ...
                        <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
                            <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                                <h3 className="text-white text-2xl md:text-3xl font-bold mb-3">Powerful suite of tools</h3>
